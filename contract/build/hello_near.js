...
let Votingcontract = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = call({}), _dec7 = view(), _dec8 = view(), _dec9 = view(), _dec10 = view(), _dec11 = view(), _dec12 = view(), _dec(_class = (_class2 = class Votingcontract {
  //  candidate pair to store candidate name and url

  candidatePair = new UnorderedMap("candidatePair");
  // prompt set

  promptset = new UnorderedSet("prompt");
  ...
  addVote({
    ...
    let currentVote = this.voteArray.get(prompt, {
      defaultValue: [0, 0]
    });
...
}, (_applyDecoratedDescriptor(_class2.prototype, "addCandidatePair", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "addCandidatePair"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "initvote", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "initvote"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addtopromptset", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "addtopromptset"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addVote", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "addVote"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "recorduser", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "recorduser"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "geturl", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "geturl"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "didparticipate", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "didparticipate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "participationarray", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "participationarray"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getallprompt", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "getallprompt"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getValue", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "getValue"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getcandidatepair", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "getcandidatepair"), _class2.prototype)), _class2)) || _class);
...
function getValue() {
  ...
  const _args = Votingcontract._getArgs();
  const _result = _contract.getValue(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Votingcontract._serialize(_result, true));
}
...
function participationarray() {
  ...
  const _args = Votingcontract._getArgs();
  const _result = _contract.participationarray(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Votingcontract._serialize(_result, true));
}
...
function addtopromptset() {
  ...
  const _args = Votingcontract._getArgs();
  const _result = _contract.addtopromptset(_args);
  Votingcontract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Votingcontract._serialize(_result, true));
}
function initvote() {
  ...
  const _args = Votingcontract._getArgs();
  const _result = _contract.initvote(_args);
  Votingcontract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Votingcontract._serialize(_result, true));
}
...
export { addCandidatePair, addVote, addtopromptset, didparticipate, getValue, getallprompt, getcandidatepair, geturl, initvote, participationarray, recorduser };
